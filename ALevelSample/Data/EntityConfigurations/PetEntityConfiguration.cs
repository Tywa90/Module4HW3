...
public class PetEntityConfiguration : IEntityTypeConfiguration<PetEntity>
{
    public void Configure(EntityTypeBuilder<PetEntity> builder)
    {
        ...
        builder.Property(p => p.CategoryId).HasMaxLength(255).IsRequired();
        builder.Property(p => p.BreedID).HasMaxLength(255).IsRequired();
        builder.Property(p => p.Age).HasMaxLength(255);
        builder.Property(p => p.LocationId).HasMaxLength(255).IsRequired();
